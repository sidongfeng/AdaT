...
if __name__ == '__main__':
    ...
    coordinate = d(text="Graticule").center()
    step = {'action': 'tap',
                'coordinate_1': coordinate,
                'coordinate_2': None,
                'duration': None,
    ...
    coordinate = d(text="Globalhash!").center()
    step = {'action': 'tap',
                'coordinate_1': coordinate,
                'coordinate_2': None,
                'duration': None,
    ...
    with open('themis_output/geohashdroid-log-#73.json', 'w') as writer:
