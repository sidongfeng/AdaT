...
class Device(object):
    ...
    def __init__(self, device_serial=None, is_emulator=False, output_dir=None,
        ...
        self.last_know_screenshot = None
        self.__used_ports = []
    ...
    def take_screenshot(self):
        ...
        if self.adapters[self.minicap] and self.minicap.last_screen:
            ...
            return self.minicap.last_screen, local_image_path
        else:
    ...
    def get_current_state(self, take_screenshot=False):
        ...
        try:
            ...
            if take_screenshot:
                ...
                current_screen, screenshot_path = self.take_screenshot()
            else:
        ...
        self.last_know_screenshot = current_screen
