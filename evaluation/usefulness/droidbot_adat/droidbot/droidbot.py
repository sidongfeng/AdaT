...
from .binary_model import Classifer
...
class DroidBot(object):
    ...
    def __init__(self,
                 ...
                 init_model=None,
                 model_name=None,
                 max_model_tries=None,
                 is_binary_classifer=None):
        """
        ...
        self.binary_classifer = None
        self.max_model_tries = max_model_tries
        self.is_binary_classifer = is_binary_classifer
        ...
        try:
            ...
            if self.is_binary_classifer:
                self.binary_classifer = Classifer(self.init_model, self.model_name)
            ...
            self.input_manager = InputManager(
                ...
                binary_classifer=self.binary_classifer,
                max_model_tries=self.max_model_tries)
    ...
    def start(self):
        ...
        try:
            ...
            if self.is_binary_classifer:
                self.binary_classifer.model_warmup()
